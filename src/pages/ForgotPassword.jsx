          ...
          <div className=" h-[calc(100vh_-_10rem)] overflow-y-auto">
            <form className="w-[90%] max-w-[468px] mx-auto h-full">
              <div className="flex flex-col items-center mb-20">
                <h1 className="font-DMSans text-[30px] font-bold mb-2 uppercase text-[#2d2d2d]">Forgot Password</h1>
                <p className="font-DMSans text-[#2d2d2d90]">Forgot Password? No worries, input your email below</p>
              </div>
