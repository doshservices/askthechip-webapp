        ...
        <div className="w-full md:w-[50%] h-screen">
          ...
          <form className="w-[90%] max-w-[468px] mx-auto h-full">
            <div className="flex flex-col items-center mb-20">
              <h1 className="font-DMSans text-[30px] font-bold mb-2 uppercase text-[#2d2d2d]">Welcome Back</h1>
              <p className="font-DMSans text-[#2d2d2d90]">Fill out the fields below to log in to your account</p>
            </div>
            ...
            <div className="font-DMSans text-sm text-center">
                Don&apos;t have an account? <Link to="/sign-up" className="font-bold text-primary90">Sign up</Link>
            </div>
          </form>
          </div>
        </div>
