...
import dividerTop from "../assets/images/divider-bottom.png"
import dividerBottom from "../assets/images/divider-top.png"
...
const Header = () => {
  return (
    <div className="font-DMSans  pt-6 overflow-hidden" id="explore">
      <section className="flex justify-center items-center flex-col">
        <section className="flex justify-center items-center flex-col sm:px-[2rem] pb-10 sm:pb-0 pt-6 relative z-10">
          ...
          <p className="text-[.9rem] md:text-[18px] w-[95%] text-center text-[#343432] relative z-2">
        ...
        <div className="my-[-20px] isolate relative">
            ...
            <div className="flex gap-4 bg-black/50">
              ...
              <div className="hidden bg-white md:grid rounded-grid grid-cols-5 gap-4">
                {images.map((image, index) => (
                  <img style={{ objectFit: "cover", width: "100%" }} className="h-full" src={image.src} key={index} />
                ))}
              </div>
