...
const Settings = () => {
  ...
  return (
    <div className="font-DMSans grid grid-cols-9">
      <div className="col-span-12 sm:col-span-4 min-h-full sm:min-h-screen border-r border-[#EBEEF0]">
        <Header />
        <div className="font-DMSans font-medium mb-5 sm:mb-10 text-2xl ml-6 pr-6 pt-6">Settings</div>
        {settingsButtons.map((button) => (
          <div className="my-4 ml-6 pr-6 pt-6" key={button.id}>
            <ButtonNew
      ...
      <div className="col-span-12 mb-5 sm:mb-0 sm:col-span-5 pt-10 sm:pt-20">
        {activeButton === 1 ? (
          <>
            {profile?.role === "USER" ? (
              <form
