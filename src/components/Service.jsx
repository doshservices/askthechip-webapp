...
const Service = ({serviceData}) => {
  ...
  return (
    <div className="col-span-8 mb-3">
      ...
      {expand && <div className="grid grid-cols-12 gap-4">
        {serviceData.data.map((service, index) => (
          <div key={index} className="col-span-6 grid grid-cols-12 pt-2 pb-4 my-2 border-b border-[#000000]/20 w-[85%] mx-auto">
