        ...
        <div>
            ...
            <div className='grid-cols-3 ml-8'>
                ...
                <div className='text-[#181818] mb-2'>
                    <div className='w-[90%] text-sm font-Montserrat mb-2'>{type=== 'personal' ?'Architect':'Industry'}</div>
                        ...
                        <div className='flex'>
                            <div>
                                <button className='bg-[#F7F9FA] font-Montserrat font-semibold border-[0.3px] border-tertiary text-tertiary flex px-4 py-[0.2rem] hover:scale-110 transition duration-200 rounded-full items-center'>
                                    <img src={envelope} alt="Settings" className='px-0.5 text-tertiary' />
                                    Send a message
                                </button>
                            </div>
                        </div>
                ...
                }
                {
                    ...
                    <div className='text-[#181818] font-semibold mt-3 text-lg'>Work Experience</div>
                    {
                        experienceData.map((xp, index) => (
                            <div className="flex my-3" key={index}>
                                ...
                                <div>
                                    ...
                                    <div className='text-[10px]'><span className='font-medium'>{xp.heading}</span> {xp.subheading}</div>
                                    <div className='text-[10px] my-1'>{xp.starting} - {xp.ending} <span className='text-tertiary font-semibold'>{xp.duration}</span></div>
                        ...
                        <div className='text-[#181818] font-Montserrat'>
                    <div className='text-[#181818] font-semibold mt-3 text-lg'>About</div>
                    {
                        aboutData.map((about, index) => (
                            <div className="flex my-3" key={index}>
                                <div className="h-[48px] w-[38px] bg-tertiary rounded-3xl mr-3"></div>
                                <div>
                                    <div className='text-[10px]'><span className='font-medium'>{about.heading}</span> {about.subheading}</div>
                                    <div className='text-[10px] mt-1 mb-[0.4rem]'>{about.address} <span className='text-tertiary font-semibold ml-4'>{about.website}</span></div>
                ...
                <div className='font-Montserrat'>
                    <div className='text-[#181818] font-semibold mt-3 text-lg'>Interests</div>
