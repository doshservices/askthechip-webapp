    ...
    <div className='grid grid-cols-9'>
        <div className='col-span-3 min-h-screen ml-6 pr-6 pt-6 border-r border-[#EBEEF0]'>
            ...
            <div className='my-4' key={button.id}>
                <ButtonNew intent={activeButton=== button.id ? `primary`: `secondary`} onClick={()=>setActiveButton(button.id)} 
          ...
          <div className='col-span-6 pt-20'>
              {activeButton === 1 ? (<div>
                  <div className="flex flex-col w-full mb-4">
                      <label htmlFor="full_name" className="mb-2 font-medium font-Inter text-left w-[80%] mx-auto">
                          Full name
                      </label>
                  ...
                  <div className="flex flex-col mb-4 w-full">
                      <label htmlFor="email" className="mb-2 font-medium font-Inter w-[80%] mx-auto">
                          Email
                      </label>
                      <div className='flex w-full justify-center'>
                          <input
                  ...
                  ? (<div><PaymentForm /></div>) : activeButton === 3 ? (<div>
                    <div className="flex flex-col w-full mb-4">
                        <label htmlFor="old_pass" className="mb-2 font-medium font-Inter text-left w-[80%] mx-auto">
                            Old Password
                        </label>
                        <div className='flex w-full justify-center'>
                            <input
                    ...
                    <div className="flex flex-col w-full mb-4">
                        <label htmlFor="new_pass" className="mb-2 font-medium font-Inter w-[80%] mx-auto">
                            New Password
                        </label>
                        <div className='flex w-full justify-center'>
                            <input
                    ...
                    <div className="flex flex-col mb-4 w-full">
                        <label htmlFor="confirm_new_pass" className="mb-2 font-medium font-Inter w-[80%] mx-auto">
                ...
                <div>
                    <div className='font-Inter ml-[10%] mr-4'>
                        ...
                        <div className='mb-2'>
                            Deleting your account will erase your current data from the platform
                        </div>
                        <div className='mb-8'>
