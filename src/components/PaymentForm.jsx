        ...
        <div className="w-[80%] rounded-lg">
          <div>
            ...
            <div className="flex items-center bg-white border border-[#757575] rounded-lg px-2 md:px-4 mt-2 mb-4">
              ...
              />
              <img src={checkCircle} alt="check circle" className="h-4" />
            </div>
          </div>
          <div className="flex">
            ...
            <div className="flex items-center bg-white border border-[#757575] rounded-lg px-2 md:px-4 mt-4 mb-6 max-w-[10ch] md:max-w-[12ch]">
              <input
                ...
                placeholder="CVV"
              />
              <img src={dots} alt="check circle" className="-mt-2 -mb-1" />
            </div>
          </div>
          <div className="flex">
            <div className="w-full">
              <h1 className="text-[#000] font-medium">Expiry Date</h1>
              <h2 className="opacity-50">Enter the expiry date of the card</h2>
            </div>
            <div className="flex">
              ...
              <div className="mt-2 mb-2 mx-1 font-medium text-[30px]">/</div>
              <div className="flex items-center bg-white border border-[#757575] rounded-lg px-2 mt-4 mb-6 max-w-[12ch]">
                <input
                  type="number"
                  name="expiry_year"
          ...
          <div className="flex">
            <div className="w-full">
              ...
              <h2 className="opacity-50">Enter your card pin</h2>
            </div>
