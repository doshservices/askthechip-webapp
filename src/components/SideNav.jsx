            ...
            <NavLink to="/home" className={({ isActive }) => isActive ? "home active" : "home"}>
              {pathname === "/home"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_1666_2089)">
                ...
                :
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M5.5 19.5H9.25V13.25H14.75V19.5H18.5V9.75L12 4.875L5.5 9.75V19.5ZM4 21V9L12 3L20 9V21H13.25V14.75H10.75V21H4Z" fill="#2D2D2D" fill-opacity="0.8" />
                </svg>
              }
              <span>Home</span>
            </NavLink>
          ...
          <li>
            <NavLink to="/services" className={({ isActive }) => isActive ? "services active" : "services"}>
              {pathname === "/services"
                ?
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_1666_2114)">
          ...
          <li>
            <NavLink to="/notifications" className={({ isActive }) => isActive ? "notifications active" : "notifications"}>
              {pathname === "/notifications"
                ...
                :
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M4 19V17.5H6.1V9.85C6.1 8.45 6.5125 7.20417 7.3375 6.1125C8.1625 5.02083 9.25 4.33333 10.6 4.05V3.325C10.6 2.94167 10.7375 2.625 11.0125 2.375C11.2875 2.125 11.6167 2 12 2C12.3833 2 12.7125 2.125 12.9875 2.375C13.2625 2.625 13.4 2.94167 13.4 3.325V4.05C14.75 4.33333 15.8417 5.02083 16.675 6.1125C17.5083 7.20417 17.925 8.45 17.925 9.85V17.5H20V19H4ZM12 22C11.4667 22 11 21.8042 10.6 21.4125C10.2 21.0208 10 20.55 10 20H14C14 20.55 13.8042 21.0208 13.4125 21.4125C13.0208 21.8042 12.55 22 12 22ZM7.6 17.5H16.425V9.85C16.425 8.61667 16 7.56667 15.15 6.7C14.3 5.83333 13.2583 5.4 12.025 5.4C10.7917 5.4 9.74583 5.83333 8.8875 6.7C8.02917 7.56667 7.6 8.61667 7.6 9.85V17.5Z" fill="#2D2D2D" fill-opacity="0.8" />
                </svg>
              }
          ...
          <li>
            <NavLink to="/mentorship" className={({ isActive }) => isActive ? "mentorship active" : "mentorship"}>
              {pathname === "/mentorship"
                ?
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_1666_2895)">
                ...
                :
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M12 23L9 20H4.5C4.1 20 3.75 19.8458 3.45 19.5375C3.15 19.2292 3 18.8833 3 18.5V3.5C3 3.1 3.15 2.75 3.45 2.45C3.75 2.15 4.1 2 4.5 2H19.5C19.8833 2 20.2292 2.15 20.5375 2.45C20.8458 2.75 21 3.1 21 3.5V18.5C21 18.8833 20.8458 19.2292 20.5375 19.5375C20.2292 19.8458 19.8833 20 19.5 20H15L12 23ZM4.5 18.5H9.6L12 20.9L14.4 18.5H19.5V3.5H4.5V18.5ZM13.425 12.475L16.625 11.075L13.425 9.675L12.025 6.475L10.6 9.675L7.425 11.075L10.6 12.475L12.025 15.675L13.425 12.475Z" fill="#2D2D2D" fill-opacity="0.8" />
                </svg>
              }
          ...
          <li>
            <NavLink to="/messages" className={({ isActive }) => isActive ? "messages active" : "messages"}>
              {pathname === "/messages"
                ?
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_1666_2232)">
          ...
          <li>
            <NavLink to="/profile" className={({ isActive }) => isActive ? "profile active" : "profile"}>
              {pathname === "/profile"
                ?
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <g clip-path="url(#clip0_1666_2952)">
          ...
          <NavLink to="/settings" className={({ isActive }) => isActive ? "settings active" : "settings"}>
            {pathname === "/settings"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 25 24" fill="none">
                <g clip-path="url(#clip0_1675_4484)">
