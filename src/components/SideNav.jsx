          ...
          <li>
            ...
            >
              <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.5 16.5H5.25V10.25H10.75V16.5H14.5V6.75L8 1.875L1.5 6.75V16.5ZM0 18V6L8 0L16 6V18H9.25V11.75H6.75V18H0Z" fill={pathname === "/home" ? "#068978" : "#2d2d2d"} fillOpacity={pathname === "/home" ? "1" : "0.8"} />
              </svg>
          ...
          >
            <li className="flex justify-center xm:justify-start text-base font-medium items-center  gap-2 my-6">
              <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 17V15.5H2.1V7.85C2.1 6.45 2.5125 5.20417 3.3375 4.1125C4.1625 3.02083 5.25 2.33333 6.6 2.05V1.325C6.6 0.941667 6.7375 0.625 7.0125 0.375C7.2875 0.125 7.61667 0 8 0C8.38333 0 8.7125 0.125 8.9875 0.375C9.2625 0.625 9.4 0.941667 9.4 1.325V2.05C10.75 2.33333 11.8417 3.02083 12.675 4.1125C13.5083 5.20417 13.925 6.45 13.925 7.85V15.5H16V17H0ZM8 20C7.46667 20 7 19.8042 6.6 19.4125C6.2 19.0208 6 18.55 6 18H10C10 18.55 9.80417 19.0208 9.4125 19.4125C9.02083 19.8042 8.55 20 8 20ZM3.6 15.5H12.425V7.85C12.425 6.61667 12 5.56667 11.15 4.7C10.3 3.83333 9.25833 3.4 8.025 3.4C6.79167 3.4 5.74583 3.83333 4.8875 4.7C4.02917 5.56667 3.6 6.61667 3.6 7.85V15.5Z" fill={pathname === "/notifications" ? "#068978" : "#2d2d2d"} fillOpacity={pathname === "/notifications" ? "1" : "0.8"} />
              </svg>
          ...
          >
            <li className="flex justify-center xm:justify-start text-base font-medium items-center gap-2 my-6">
              <svg width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 21L6 18H1.5C1.1 18 0.75 17.8458 0.45 17.5375C0.15 17.2292 0 16.8833 0 16.5V1.5C0 1.1 0.15 0.75 0.45 0.45C0.75 0.15 1.1 0 1.5 0H16.5C16.8833 0 17.2292 0.15 17.5375 0.45C17.8458 0.75 18 1.1 18 1.5V16.5C18 16.8833 17.8458 17.2292 17.5375 17.5375C17.2292 17.8458 16.8833 18 16.5 18H12L9 21ZM1.5 16.5H6.6L9 18.9L11.4 16.5H16.5V1.5H1.5V16.5ZM10.425 10.475L13.625 9.075L10.425 7.675L9.025 4.475L7.6 7.675L4.425 9.075L7.6 10.475L9.025 13.675L10.425 10.475Z" fill={pathname === "/mentorship" ? "#068978" : "#2d2d2d"} fillOpacity={pathname === "/mentorship" ? "1" : "0.8"} />
              </svg>
