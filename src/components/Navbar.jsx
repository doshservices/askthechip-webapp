...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="absolute top-[90vh] right-10 text-white bg-tertiary p-2 rounded-xl cursor-pointer hover:scale-90">
      ...
      >
        ...
        <div className="flex md:hidden z-20">
          ...
          <div
            ref={navRef}
            className={`flex translate-x-[100%]  bg-white z-[2] md:hidden transition flex-col w-[70%] items-center font-body uppercase my-auto h-screen fixed top-0 right-0`}
          >
            <div
